...
dirinfo = dir(fullfile(vox_folder,subfolder_names(group_id)));
...
for K = 1 : length(dirinfo)
  ...
  dcmfiles =[dcmfiles;fullfile(vox_folder,subfolder_names(group_id),thisdir)];
  end
end


for pth_id =start_id:1:numel(dcmfiles)
    pth_id
    close all;
